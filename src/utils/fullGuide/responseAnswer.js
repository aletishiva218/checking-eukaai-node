const behavioralAndLeadershipResponse = {
  name: "Behavioral and Leadership",
  quickSummary:
    "This guide helps candidates prepare for behavioral interviews by aligning leadership examples to the company's culture and values. It introduces the SPSIL story format, gives practical rehearsal techniques, and dives into core leadership principles like Ownership, Customer Obsession, and Delivering Results with deep questions to reflect on.",
  subModules: [
    {
      title: "Understand the Company Culture",
      completed: 0,
      summary:
        "Leadership isn't one-size-fits-all. The leadership that thrives at Amazon (structured, narrative-driven) is different from the leadership that thrives at Meta (fast, bottom-up). This interview is your chance to prove you are the right kind of leader for them. Your goal is to align your personal story with their company values.",
      htmlContent:
        "<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>\
  <h2 class='text-lg font-semibold text-gray-50'>How to Decode Their Culture</h2>\
  <ol class='list-decimal pl-6 space-y-2 text-gray-300'>\
  <li>Research Their Principles: Go beyond the mission statement. Read their leadership principles (like Amazon's 14 LPs) or engineering blogs. What behaviors do they explicitly celebrate? Is it \"Bias for Action\" or \"Think Big\"</li>\
  <li>Understand PM Influence: How do decisions <i>actually</i> get made? Is it through data-driven arguments (Google, Meta), detailed written narratives (Amazon), or strong design-led vision (Apple)?</li>\
  <li>Align Your Narrative: Intentionally choose stories from your past that reflect their values.</li>\
  </ol>\
  <ul class='list-disc pl-6 space-y-2 text-gray-300'>\
  <li>Interviewing at Meta? Tell the story of the fast, scrappy experiment you launched in two weeks to get data, not the one about the year-long waterfall project.</li>\
  <li>Interviewing at Amazon? Talk about a time you started with the customer's problem and worked backward, or when you had to dive deep into data to make a tough call.</li>\
  </ul>\
  <p class='text-gray-300'>Show them you not only understand their culture but that you've already lived it.</p>\
  </div>",
    },
    {
      ...
      htmlContent:
        "<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>\
  <h2 class='text-lg font-semibold text-gray-50'>SPSIL Framework</h2>\
  <p class='text-gray-300'>You need 3–5 powerful stories you can adapt to any behavioral question. The SPSIL format is more effective than STAR because there is a \"Lessons\" part that demonstrates introspection and key learnings from your role to show true leadership.</p>\
  <ul class='list-disc pl-6 space-y-2 text-gray-300'>\
  <li>S - Situation: One sentence. Minimal context.</li>\
  <li>P - Problem: The core challenge or conflict.</li>\
  <li>S - Solution: What you specifically did. Use \"I\" statements.</li>\
  <li>I - Impact: Quantify the result. Use numbers.</li>\
  <li>L - Lessons: What you learned about yourself or your process.</li>\
  </ul>\
  <h2 class='text-lg font-semibold text-gray-50'>Sample story of leadership & influence</h2>\
  <p class='text-gray-300'>My team was assigned to build a \"pet project\" from a senior VP. The team was demotivated because the project had no clear user need and would distract from our core goals. I built a simple opportunity cost model showing that the project would delay our main roadmap by 2 months, putting our $5M revenue goal at risk. I presented this data to the VP, acknowledging his idea's potential but framing it against our primary commitments. He agreed to de-prioritize the project, saving the team from months of wasted work and keeping our core goals on track. I learned that the most effective way to influence up is to frame the discussion around shared goals and objective data, not opinions.</p>\
  </div>",
    },
    {
      ...
      completed: 0,
      summary:
        "There are five main themes of questions you will get asked about during your behavioral interview. The practical tips is here to help you practice delivering your SPSIL stories during the interview.",
      htmlContent:
        "<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>\
  <h2 class='text-lg font-semibold text-gray-50'>Map SPSIL Stories to Common Themes</h2>\
  <ol class='list-decimal pl-6 space-y-2 text-gray-300'>\
  <li>Drive & Motivation: Why Product Management? Why this company?</li>\
  <li>Leading & Managing Conflict: Tell me about a time you disagreed with a stakeholder? How do you handle difficult teammates?</li>\
  <li>Driving Results: Tell me about a time you had to deliver with limited resources or data.</li>\
  <li>Growth & Learning: What's a major failure you've had? Tell me about a time you had to learn a new skill quickly.</li>\
  <li>Cross-Functional Collaboration: How do you align multiple teams? Tell me about a project that involved marketing, sales, and engineering.</li>\
  </ol>\
  <h2 class='text-lg font-semibold text-gray-50'>Rehearsal Techniques</h2>\
  <ul class='list-disc pl-6 space-y-2 text-gray-300'>\
  <li>Whiteboard / Sticky Notes: Write your core stories (just the SPSIL bullet points) on sticky notes. Have a friend ask you random behavioral questions. Practice grabbing the right story and adapting it on the fly. This builds mental flexibility and stops you from sounding like a robot.</li>\
  <li>Voice Memo Playback: Record yourself answering a question. Play it back. This is the fastest way to catch filler words (\"um,\" \"like,\" \"you know\"), rambling, and awkward pacing. It's painful but incredibly effective.</li>\
  <li>Peer Mock Interviews: Find another PM who is also prepping. Use the prompts in this guide and give each other honest, direct feedback. This is the best way to simulate the pressure of a live interview.</li>\
  <li>The Leadership Grid (Pro Tip): Create a spreadsheet. Make the rows your SPSIL stories. Make the columns the company's leadership principles (e.g., Amazon's LPs). This forces you to map every story to a value, ensuring you're always communicating in a way that resonates with the interviewer's own framework for success.</li>\
  </ul>\
  </div>",
    },
    {
      ...
      completed: 0,
      summary:
        "This section will help you exercise key muscles for your behavioral interview and guide your thinking to choose a solid example. This is very comprehensive so only choose the sections that seem most relevant to the company’s values.",
      htmlContent:
        "<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>\n\n<h2 class='text-lg font-semibold text-gray-50'>Customer Obsession</h2>\n<p class='text-gray-300'>Think about a time you put the customer first, even when it wasn’t easy or convenient. This is about working vigorously to earn and keep customer trust.</p>\n<p class='text-gray-300'>To help you choose a strong moment, consider these questions:</p>\n<ul class='list-disc pl-6 space-y-2 text-gray-300'>\n<li>Was this a situation with a single, high-stakes customer, or did your actions impact a broad group of users?</li>\n<li>What was the central conflict? Were you balancing the customer's needs against a technical limitation, a business policy, or a tight deadline?</li>\n<li>What was the risk if you failed to act? Losing the customer, damaging the brand's reputation, or missing a key opportunity?</li>\n</ul>\n<hr class='my-6 border-gray-700'>\n\n<h2 class='text-lg font-semibold text-gray-50'>Ownership</h2>\n<p class='text-gray-300'>Recall a time you stepped up and took full ownership, acting on behalf of the entire company, not just your own team. Let's get specific:</p>\n<ol class='list-decimal pl-6 space-y-2 text-gray-300'>\n<li>Was this a project or task that no one else wanted, or was it something that had been dropped or was failing?</li>\n<li>What was the potential negative outcome if you hadn't taken responsibility?</li>\n<li>Did you have to make a decision or take a risk without a clear green light from your manager?</li>\n</ol>\n<hr class='my-6 border-gray-700'>\n\n</div>",
    },
  ],
};

const analyticalEstimationResponse = {
  name: "Analytical Estimation",
  quickSummary:
    "The analytical estimation round assesses your quantitative reasoning, problem-solving with incomplete data, and structured decision-making. It covers market sizing, metrics, A/B testing, and root cause analysis, focusing on your thought process over the 'right' answer.",
  subModules: [
    {
      title: "What Is the Analytical Estimation/Execution Round?",
      completed: 0,
      summary:
        'The analytical estimation or "execution" round tests your ability to think quantitatively, solve problems with incomplete data, and make structured decisions under pressure. This is where companies assess whether you can handle the data-driven aspects of product management.',
      htmlContent:
        "<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>\
  <h2 class='text-xl font-bold text-gray-50'>What Interviewers Are Testing</h2>\
  <p class='text-gray-300'><strong>Core Skills Being Evaluated:</strong></p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li><strong>Structured thinking</strong> - Can you break down complex problems logically?</li>\
  <li><strong>Quantitative reasoning</strong> - Are you comfortable working with numbers and making calculations?</li>\
  <li><strong>Data interpretation</strong> - Can you analyze information and draw meaningful insights?</li>\
  <li><strong>Business judgment</strong> - Do you understand what drives business value?</li>\
  <li><strong>Clear communication</strong> - Can you explain your thinking process clearly?</li>\
  </ul>\
  <p class='text-gray-300'><strong>Key Point:</strong> Interviewers care more about how you think than getting the \"right\" answer.</p>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Common Question Types</h2>\
  <h3 class='text-lg font-semibold text-gray-100'>Market Sizing</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>\"How many Uber rides happen in NYC daily?\"</li>\
  <li>\"What's the market size for meal delivery apps?\"</li>\
  </ul>\
  <h3 class='text-lg font-semibold text-gray-100'>Metrics & KPIs</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>\"How would you measure success for Instagram Stories?\"</li>\
  <li>\"Our engagement is down 15% - how do you investigate?\"</li>\
  </ul>\
  <h3 class='text-lg font-semibold text-gray-100'>A/B Testing</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>Business Analysis</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>Root Cause Analysis</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>\"Daily active users dropped 25% last month. Walk me through your investigation.\"</li>\
  </ul>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Why This Round Matters</h2>\
  <p class='text-gray-300'>Modern PMs must be data-driven. You'll regularly need to:</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Sample Questions with Context</h2>\
  <h3 class='text-lg font-semibold text-gray-100'>Market Sizing Example:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>Metrics Example:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>A/B Test Example:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Quick Tips for Success</h2>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <li><strong>Check your math</strong> - Do quick sanity checks on your calculations</li>\
    ...
    },
    {
      ...
      completed: 0,
      summary:
        'Market sizing questions ask you to estimate quantities without any data - like "How many cups of coffee are sold in NYC daily?" or "How many people buy glasses in the US each year?" These questions test your ability to break down ambiguous problems and make reasonable assumptions. The interviewer doesn\'t care about the exact answer - they want to see your structured thinking process.',
      htmlContent:
        "<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>\
  <h2 class='text-xl font-bold text-gray-50'>The 5-Step Framework</h2>\
  <ol class='list-decimal pl-6 space-y-2 text-gray-300'>\
  <li>\
  <p><strong>Clarify the question</strong></p>\
  ...
  <li>\
  <p><strong>Break into pieces</strong></p>\
  <p>Don't estimate one huge number. Break it into smaller, manageable chunks.</p>\
  </li>\
  <li>\
  <p><strong>State assumptions clearly</strong></p>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Example: \"How many cups of coffee sold in NYC daily?\"</h2>\
  <p class='text-gray-300'><strong>Clarify:</strong> All five boroughs, all coffee sales</p>\
  <p class='text-gray-300'><strong>Approach:</strong> Top-down (population-based)</p>\
  <p class='text-gray-300'><strong>Break it down:</strong></p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'><strong>Assumptions:</strong></p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>70% drink coffee</li>\
  <li>Average 2 cups per day</li>\
  <li>10M × 0.7 × 2 = 14M cups daily</li>\
  </ul>\
  <p class='text-gray-300'><strong>Sanity check:</strong> 1.4 cups per person seems reasonable</p>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Example: \"How many people buy glasses in US annually?\"</h2>\
  <p class='text-gray-300'><strong>Break it down:</strong></p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'><strong>Calculate:</strong> 200M ÷ 2.5 = 80M purchases annually</p>\
  <p class='text-gray-300'><strong>Sanity check:</strong> 1 in 4 Americans buy glasses yearly - makes sense</p>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Key Tips</h2>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Common Mistakes</h2>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <li>Not stating assumptions clearly</li>\
    ...
    },
    {
      ...
      completed: 0,
      summary:
        "Metric definition questions ask you to identify how to measure success for a product or feature. The key is connecting business goals to measurable outcomes. Here is a concrete sample that can help you to structure your responses.",
      htmlContent:
        "<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>\
  <h2 class='text-xl font-bold text-gray-50'>Framework: Goals → Leading → Lagging</h2>\
  <h3 class='text-lg font-semibold text-gray-100'>1. Understand the goal</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>What is this product/feature trying to achieve?</li>\
  </ul>\
  <h3 class='text-lg font-semibold text-gray-100'>2. Define leading indicators</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>Early signals that predict success (user behavior, engagement)</li>\
  </ul>\
  <h3 class='text-lg font-semibold text-gray-100'>3. Define lagging indicators</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>Final outcomes that prove success (revenue, retention, growth)</li>\
  </ul>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Example: Video Sharing Feature</h2>\
  <p class='text-gray-300'><strong>Goal:</strong> Increase user engagement and content creation</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Leading metrics:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>Video upload rate</li>\
  <li>Share button clicks</li>\
  <li>Time spent watching videos</li>\
  </ul>\
  <h3 class='text-lg font-semibold text-gray-100'>Lagging metrics:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>Monthly active users</li>\
  <li>User retention (7-day, 30-day)</li>\
  <li>Revenue per user</li>\
  </ul>\
  <h3 class='text-lg font-semibold text-gray-100'>Answer structure:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>\"I'd track video uploads daily as a leading indicator of content creation, and 30-day retention as a lagging indicator of whether the feature drives long-term engagement.\"</li>\
    ...
    },
    {
      ...
      completed: 0,
      summary:
        "One of the analytical questions can pose you to diagnose why certain metrics dropped for a feature or a product. When a key metric drops unexpectedly in a given problem, use the following systematic approach to find the root cause.",
      htmlContent:
        "<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>\
  <h2 class='text-xl font-bold text-gray-50'>The PUTE Framework</h2>\
  <p class='text-gray-300'>Think through what recent changes could affect the metrics. Use the following framework as reference to diagnose the problem. Think through the:</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Product changes</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>Recent feature launches</li>\
  <li>A/B tests running</li>\
  <li>Algorithm changes</li>\
  </ul>\
  <h3 class='text-lg font-semibold text-gray-100'>User behavior change</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>Seasonal patterns</li>\
  <li>Cohort differences</li>\
  <li>Geographic variations</li>\
  </ul>\
  <h3 class='text-lg font-semibold text-gray-100'>Technical issues</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>Bugs or outages</li>\
  <li>Performance problems</li>\
  <li>Tracking errors</li>\
  </ul>\
  <h3 class='text-lg font-semibold text-gray-100'>External factors</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>For example if \"DAU dropped 20% overnight\"</h2>\
  <h3 class='text-lg font-semibold text-gray-100'>Step 1: Segment the data</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>Which user groups are affected?</li>\
  <li>What platforms/regions?</li>\
  <li>New vs returning users?</li>\
  </ul>\
  <h3 class='text-lg font-semibold text-gray-100'>Step 2: Check timing</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>When exactly did it start?</li>\
  <li>Gradual or sudden drop?</li>\
  <li>Any releases that day?</li>\
  </ul>\
  <h3 class='text-lg font-semibold text-gray-100'>Step 3: Investigate causes</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>Step 4: Prioritize investigation</h3>\
  <p class='text-gray-300'>Start with most likely causes based on timing and magnitude. With enough practice, these concepts will become easier and there will be less interview anxiety.</p>\
  </div>",
    },
    {
      ...
      completed: 0,
      summary:
        "In PM interviews, A/B testing questions test your ability to design experiments and make decisions from data. Keep it simple and business-focused.",
      htmlContent:
        "<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>\
  <h2 class='text-xl font-bold text-gray-50'>4-Step Test Design</h2>\
  <h3 class='text-lg font-semibold text-gray-100'>1. Hypothesis</h3>\
  <p class='text-gray-300'>\"If [change], then [metric] will [improve X%] because [user reason]\"</p>\
  <h3 class='text-lg font-semibold text-gray-100'>2. Setup</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>3. Success metrics</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li><strong>Primary:</strong> What you're optimizing</li>\
  <li><strong>Guardrails:</strong> What you can't break</li>\
  </ul>\
  <h3 class='text-lg font-semibold text-gray-100'>4. Decision criteria</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>What result makes you ship vs. kill the deal?</li>\
  </ul>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Example: Testing Simplified Signup Flow</h2>\
  <p class='text-gray-300'><strong>Hypothesis:</strong> \"If we reduce signup from 5 fields to 3, conversion will increase 20% because less friction\"</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Setup:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li><strong>Control:</strong> 5-field form</li>\
  <li><strong>Treatment:</strong> 3-field form</li>\
  <li>2,000 users per group, 1 week</li>\
  </ul>\
  <h3 class='text-lg font-semibold text-gray-100'>Metrics:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li><strong>Primary:</strong> Signup completion rate</li>\
  <li><strong>Guardrails:</strong> Profile completeness, user quality</li>\
  </ul>\
  <p class='text-gray-300'><strong>Decision:</strong> Ship if >10% improvement with no guardrail issues</p>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Analyzing Results</h2>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>What Interviewers Want to See</h2>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Quick Reminders</h2>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
...
const productStrategyResponse = {
  ...
  <p class='text-gray-300'>That's strategy. And it matters because companies don’t want a task-doer — they want someone who knows where to steer the ship. These questions help interviewers see if you can:</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>How is Product Strategy different from Product Design?</h2>\
  <p class='text-gray-300'>Product strategy focuses on <strong>what</strong> should be built and <strong>why</strong> — the big-picture thinking, product-market fit, growth strategy, and goals. Strategy is the <strong>map</strong>.</p>\
  <p class='text-gray-300'>Product design focuses on <strong>how</strong> to build the product — user experience, usability, UX flows, and delight. Design is <strong>how smooth the ride is once you’re on the road</strong>.</p>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>What Top Companies Are Really Looking For</h2>\
  <p class='text-gray-300'>Places like Meta, Stripe, Amazon, and Spotify want to see if you can:</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'>They’re not testing if you have a PhD in product management. They’re testing if you can think clearly, prioritize well, and justify your decisions.</p>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Common Real Product Strategy Questions</h2>\
  <p class='text-gray-300'>Some examples I’ve seen and practiced with:</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'>These all boil down to: <i>Can you connect product work to real goals and explain your thinking in a structured way?</i></p>\
</div>",
    },
    {
  ...
  <p class='text-gray-300'><strong>What it is:</strong> Before diving into solutions, nail down exactly what success looks like. Most candidates jump straight to brainstorming, but the best PMs spend time upfront ensuring they're solving the right problem.</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Key Questions to Ask:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'><strong>Example:</strong> Interviewer: <i>\"How would you grow our marketplace platform?\"</i></p>\
  <p class='text-gray-300'><strong>Your Response:</strong> \"Before I dive into growth strategies, let me clarify a few things. When you say 'grow,' are we primarily focused on user acquisition, revenue growth, or engagement? What's our current biggest bottleneck - supply side, demand side, or conversion? And what's the timeline we're working with - are we looking for quick wins or sustainable long-term growth?\"</p>\
  <p class='text-gray-300'>This shows you think strategically and don't make assumptions.</p>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Step 2: Analyze the Market</h2>\
  <p class='text-gray-300'><strong>What it is:</strong> Demonstrate market awareness by analyzing the competitive landscape, user behavior, and market dynamics. This isn't about showing off. It's about grounding your strategy in reality.</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Framework to Use:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'><strong>Example:</strong> <i>Sample answer for a food delivery app growth question:</i></p>\
  <p class='text-gray-300'>\"Let me analyze the current market landscape. The food delivery market is still growing but slowing post-COVID, with increased competition from DoorDash, Uber Eats, and regional players. Users are becoming more price-sensitive and demanding faster delivery times. I'm seeing trends toward ghost kitchens and vertical integration. Our key advantage seems to be [X], but we're facing pressure on [Y]. This context will shape which growth strategies make sense.\"</p>\
  <p class='text-gray-300'><strong>Pro Tip:</strong> If you don't know specific market details, be honest but show your thinking process: \"I'd want to research the exact market size, but based on general trends I'm seeing...\"</p>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Step 3: Evaluate Strategic Options</h2>\
  <p class='text-gray-300'><strong>What it is:</strong> Generate 2-3 distinct strategic buckets and evaluate each one systematically. Don't just list options. Show how you think through trade-offs.</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Evaluation Criteria:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'><strong>Example Structure:</strong> <i>For growing a B2B SaaS product:</i></p>\
  <p class='text-gray-300'>\"I see three main strategic options:</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Option 1: Expand Market Reach</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>Option 2: Deepen Customer Value</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>Option 3: Platform Strategy</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'>Each has different resource requirements and risk profiles...\"</p>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Step 4: Prioritize with Trade-Offs</h2>\
  <p class='text-gray-300'><strong>What it is:</strong> Make a clear recommendation and explain your reasoning. The best PMs don't just pick an option. They articulate why they chose that option over alternatives and how they'd mitigate risks.</p>\
  <h3 class='text-lg font-semibold text-gray-100'>How to Frame Trade-Offs:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>Example in Action:</h3>\
  <p class='text-gray-300'>\"I'm recommending we focus on deepening customer value (option 2) over expanding market reach. Here's my reasoning:</p>\
  <p class='text-gray-300'><strong>Why this over market expansion:</strong> While new markets have higher upside, our current customer retention rate of 85% suggests we're not maximizing value from existing relationships. It's typically 5-7x cheaper to expand existing accounts than acquire new ones.</p>\
  <p class='text-gray-300'><strong>Key Trade-Off:</strong> We're trading potential rapid growth for sustainable, profitable growth. This is the right choice given our current burn rate and the need to show unit economics improvement.</p>\
  <p class='text-gray-300'><strong>Risk Mitigation:</strong> The main risk is that we hit a ceiling on expansion within existing accounts. I'd mitigate this by setting clear expansion metrics and having a 'pivot trigger' - if we don't see 20% expansion revenue within 6 months, we re-evaluate.\"</p>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Step 5: Define Success Metrics & Next Steps</h2>\
  <p class='text-gray-300'><strong>What it is:</strong> Show you can translate strategy into measurable outcomes and concrete next steps. This demonstrates you can execute, not just strategize.</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Metrics Framework:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'><strong>Example Structure:</strong> For the customer value expansion strategy:</p>\
  <p class='text-gray-300'>\"Here's how I'd measure success and roll this out:</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Success Metrics:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>MVP Approach:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>Key Assumptions to Test:</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Putting It All Together</h2>\
  <p class='text-gray-300'>This framework works because it:</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'><strong>Practice Tip:</strong> Don't memorize this framework but do internalize the logic. Do some mock interviews with friends and with enough practice goals, context, options, trade-offs, and measurement will become natural ways of thinking. Use this structure as training wheels until it becomes second nature.</p>\
  <p class='text-gray-300'>Remember, interviewers aren't looking for the \"right\" answer. They want to see how you think through complex problems and make decisions with incomplete information. This framework gives you a reliable way to showcase that thinking process.</p>\
  </div>",
    },
    {
      ...
      completed: 0,
      summary:
        "There are broadly 5 types of product strategy questions. These mock questions will help you practice different muscles needed to creatively think through your strategy for monetization, growth, competition, market expansion and the portfolio of products. The hints are here simply as suggestions, so don’t be afraid to take your own creative path to test your strategy skills.",
      type: "ol",
      htmlContent:
        "<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>\
  <ol class='list-decimal pl-6 space-y-4 text-gray-300'>\
  <li>\
  <h2 class='text-xl font-bold text-gray-50'>Monetization Strategy:</h2>\
  <p class='text-gray-300'><i>\"How would you monetize a product like Google Maps?\"</i></p>\
  <p class='text-gray-300'><i><b>Hint:</b></i> <span class='text-gray-400'>Think about who uses it (consumers, businesses), who pays today (advertisers, API users), and where untapped value might lie. Consider freemium models, partnerships, or upsells for high-intent users.</span></p>\
  </li>\
  <li>\
  <h2 class='text-xl font-bold text-gray-50'>Growth Strategy:</h2>\
  <p class='text-gray-300'><i>\"Instagram usage is declining among Gen Z. What would you do?\"</i></p>\
  <p class='text-gray-300'><i><b>Hint:</b></i> <span class='text-gray-400'>Start with why. Do discovery: is it product fatigue, competition, cultural shift? Segment users by behavior and platform. Then brainstorm features, partnerships, or changes in positioning to re-engage that group.</span></p>\
  </li>\
  <li>\
  <h2 class='text-xl font-bold text-gray-50'>Competitive Defense:</h2>\
  <p class='text-gray-300'><i>\"Spotify’s podcast dominance is being challenged by YouTube. What’s your strategy?\"</i></p>\
  <p class='text-gray-300'><i><b>Hint:</b></i> <span class='text-gray-400'>Think in layers: product experience, creator ecosystem, monetization. Where is YouTube stronger? Where is Spotify better? Consider exclusive content, algorithm upgrades, and creator incentives.</span></p>\
  </li>\
  <li>\
  <h2 class='text-xl font-bold text-gray-50'>Market Expansion:</h2>\
  <p class='text-gray-300'><i>\"How would you expand Duolingo into a new international market?\"</i></p>\
  <p class='text-gray-300'><i><b>Hint:</b></i> <span class='text-gray-400'>Pick a specific country. Think about language demand, mobile access, cultural attitudes toward learning, and local competitors. Then outline a go-to-market plan (product, pricing, partnerships, promotion).</span></p>\
  </li>\
  <li>\
  <h2 class='text-xl font-bold text-gray-50'>Product Portfolio Strategy:</h2>\
  <p class='text-gray-300'><i>\"You’re PM at Amazon. Should Prime Gaming be bundled or spun out as its own service?\"</i></p>\
  <p class='text-gray-300'><i><b>Hint:</b></i> <span class='text-gray-400'>Use a decision framework. What’s the business goal? Retention, revenue, user growth or something else? Evaluate the pros and cons of bundling (cross-sell potential, complexity, cost). Then recommend based on customer value and business alignment.</span></p>\
  </li>\
  </ol>\
  </div>",
    },
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Category: Product Creativity & Strategy</h2>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Category: Tech & Execution Insight</h2>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
...
const productSenseResponse = {
  ...
  subModules: [
    {
      ...
      completed: 0,
      summary:
        "Product sense is your ability to look at a product and confidently say: “Here’s what makes it work, here’s what’s missing, and here’s how I’d make it better.” It’s how you connect the dots between user needs, product design, and business impact and it’s one of the most important skills interviewers look for in a PM candidate.",
      content:
        "Product sense allows you to identify how a product works, what's lacking, and how to improve it. It blends empathy, creativity, and judgment to align product experience with user needs and business outcomes.",
      htmlContent: `<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>
  <h2 class='text-lg font-semibold text-gray-50 mb-2'>Why It Matters</h2>
  <p class='text-gray-300'>Great PMs don’t just ship features — they solve real problems. Product sense shows that you:</p>
  ...
  <p class='text-gray-300'>Strong product sense proves that you care not just about what gets built, but why it matters.</p>
  <hr class='my-6 border-gray-700'/>

  <h2 class='text-lg font-semibold text-gray-50 mb-2'>Core Traits Interviewers Look For</h2>
  <ul class='list-disc pl-5 space-y-1 text-gray-300'>
  ...
  <h2 class='text-lg font-semibold text-gray-50 mb-2'>Example: Notion</h2>
  <p class='text-gray-300'>“One of my favorite products is Notion. I use it to track books I’m reading, plan projects, and connect ideas. It’s modular and keeps my brain organized. But search can be frustrating. I’d add smart tagging or semantic search to help resurface content.”</p>
  <ul class='list-disc pl-5 space-y-1 text-gray-300'>
  ...
  <h2 class='text-lg font-semibold text-gray-50 mb-2'>Takeaway</h2>
  <p class='text-gray-300'><strong>Product sense = empathy + creativity + judgment.</strong></p>
  <p class='text-gray-300'>Show interviewers: "I don’t just use products. I understand them. And I know how to make them better.”</p>
</div>`,
    },
    {
      ...
      completed: 0,
      summary:
        "A curated list of real-world product sense interview questions from companies like Meta, Google, Amazon, and more. These help candidates practice user-centric thinking, product improvements, and strategic planning for tech products.",
      content:
        "Use these questions to practice framing answers around user needs, product metrics, and improvement ideas. These cover a range of company-specific scenarios, helping you generalize product sense strategies.",
      htmlContent: `
<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>
  <h2 class='text-lg font-semibold text-gray-50 mb-2'>Meta</h2>
  <ul class='list-disc pl-5 space-y-1 text-gray-300'>
  ...
  <h2 class='text-lg font-semibold text-gray-50 mb-2'>Google</h2>
  <ul class='list-disc pl-5 space-y-1 text-gray-300'>
  ...
  <h2 class='text-lg font-semibold text-gray-50 mb-2'>Amazon</h2>
  <ul class='list-disc pl-5 space-y-1 text-gray-300'>
  ...
  <h2 class='text-lg font-semibold text-gray-50 mb-2'>Netflix</h2>
  <ul class='list-disc pl-5 space-y-1 text-gray-300'>
  ...
  <h2 class='text-lg font-semibold text-gray-50 mb-2'>OpenAI</h2>
  <ul class='list-disc pl-5 space-y-1 text-gray-300'>
  ...
  <h2 class='text-lg font-semibold text-gray-50 mb-2'>Microsoft</h2>
  <ul class='list-disc pl-5 space-y-1 text-gray-300'>
  ...
  <h2 class='text-lg font-semibold text-gray-50 mb-2'>Stripe</h2>
  <ul class='list-disc pl-5 space-y-1 text-gray-300'>
...
<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>
  ...
  <ul class='list-disc pl-5 space-y-1 text-gray-300'>
    ...
    },
    {
      ...
      completed: 0,
      summary:
        "A structured framework to approach product sense interview questions. Includes steps like clarifying the problem, user segmentation, pain points, brainstorming, product vision, MVP prioritization, and recap — helping you think like a PM from start to finish.",
      content:
        "This step-by-step breakdown helps you confidently tackle any product sense question by guiding your thought process. You’ll learn to define the problem, focus on users, and deliver strategic, user-centered solutions.",
      htmlContent: `
<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>
  <h2 class='text-lg font-semibold text-gray-50 mb-2'>Steps Summary</h2>
  <ul class='list-decimal pl-5 space-y-1 text-gray-300'>
  ...
  <p class='mt-4 text-gray-300'>Use this structure to show how you think like a product manager — user-first, solution-driven, and impact-aware.</p>
</div>`,
    },
    {
      ...
      completed: 0,
      summary:
        "This module gives you a set of example product sense interview prompts, complete with helpful hints, and teaches you how to elevate your answers from solid to standout. You’ll also learn common mistakes to avoid so you can walk in prepared and confident.",
      content:
        "This module gives you a set of example product sense interview prompts, complete with helpful hints, and teaches you how to elevate your answers from solid to standout. You’ll also learn common mistakes to avoid so you can walk in prepared and confident.",
      htmlContent:
        "<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>\
  <h2 class='text-lg font-semibold text-gray-50 mb-2'>Practice Questions with Hints</h2>\
  <p class='text-gray-300'>Here are 5 prompts across different domains with light guidance to help you warm up your thinking:</p>\
  <ul class='list-disc pl-5 space-y-2 text-gray-300'>\
    <li><strong>1. Redesign Instagram DMs:</strong> How would you improve Instagram’s direct messaging experience? <br/><i class='text-gray-400'>Hint:</i> <span class='text-gray-300'>Consider use cases like group chats, creator-fan interaction, spam filtering, or cross-platform communication.</span></li>\
    <li><strong>2. Build a feature for Uber drivers:</strong> Imagine you’re building a new feature for Uber’s driver app. What would you build and why? <br/><i class='text-gray-400'>Hint:</i> <span class='text-gray-300'>Think about driver pain points—earnings transparency, safety, downtime, navigation, etc.</span></li>\
    <li><strong>3. Design a learning feature for Duolingo:</strong> You’re launching a new feature for Duolingo to help intermediate learners stay engaged. What do you build? <br/><i class='text-gray-400'>Hint:</i> <span class='text-gray-300'>Look at retention challenges, gamification, habit loops, or social accountability.</span></li>\
    <li><strong>4. Improve LinkedIn for job seekers:</strong> How would you improve LinkedIn’s job search experience for college seniors? <br/><i class='text-gray-400'>Hint:</i> <span class='text-gray-300'>Think about segmentation by confidence level, guidance needs, or industries. Consider emotional barriers too.</span></li>\
    <li><strong>5. Build a productivity tool for remote teams:</strong> You’ve been asked to build a new tool to help remote teams feel more connected. What’s your idea? <br/><i class='text-gray-400'>Hint:</i> <span class='text-gray-300'>Think async vs sync, calendar fatigue, spontaneous connection, or rituals that build team identity.</span></li>\
  </ul>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-lg font-semibold text-gray-50 mb-2'>Elevate Your Product Sense Thinking</h2>\
  <p class='text-gray-300'>Good product sense shows structure. Great product sense shows insight. Here’s how to level up each part of your answer:</p>\
  <ul class='list-disc pl-5 space-y-2 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-lg font-semibold text-gray-50 mb-2'>Common Mistakes to Avoid</h2>\
  <ul class='list-disc pl-5 space-y-2 text-gray-300'>\
...
const technicalResponse = {
  ...
  subModules: [
    {
      ...
      htmlContent:
        "<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>\
  <h2 class='text-xl font-bold text-gray-50'>What Are Interviewers Looking For?</h2>\
  <p class='text-gray-300'>Let's get straight to the point. When an interviewer at Meta or Google asks you to \"Design a system for photo tagging,\" they aren't expecting you to write a single line of Python. They're looking for a few key things:</p>\
  <p class='text-gray-300'>They are testing your ability to be the engineering team's most valuable partner. They want to know:</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'>At its core, the technical interview assesses your <strong>product sense through a technical lens.</strong> It's about proving you can lead a team to build the <strong>right thing</strong> in the <strong>right way.</strong> Your ability to be a strong technical partner is measured across six interconnected areas. Let's break down what they are and what they mean for you.</p>\
  <h3 class='text-lg font-bold text-gray-100'>1. Technical Understanding</h3>\
  <p class='text-gray-300'>This isn’t about knowing specific programming languages. It’s about grasping foundational concepts. Think about systems at a high level: What’s a front-end vs. a back-end? What’s an API and why is it useful? What’s the basic idea of a database? You need to show you can conceptualize how a product is built, from the user's screen all the way to the servers that power it.</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-bold text-gray-100'>2. Data Literacy</h3>\
  <p class='text-gray-300'>This is your ability to think critically about data. It’s not just reading a chart; it's asking the right questions about it. Where did this data come from? What biases might exist? What data <em>don't</em> we have? Interviewers want to see that you can use data to form a hypothesis, identify what you need to measure, and understand the \"so what\" behind the numbers.</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li><strong>Example Question:</strong> <i>\"How would you measure the success of a new feature on Google Maps?\"</i></li>\
  </ul>\
  <h3 class='text-lg font-bold text-gray-100'>3. Metrics Fluency</h3>\
  <p class='text-gray-300'>This is the next level of data literacy. It’s about defining what success looks like in quantifiable terms. You need to be able to identify a North Star Metric, propose supporting metrics, and crucially identify counter-metrics that prevent you from optimizing for the wrong thing. This shows you understand how your product creates value for both the user and the business.</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Sample Example: \"How does Google Maps calculate ETA?\"</h2>\
  <p class='text-gray-300'><strong>Interviewer:</strong> “Can you walk me through how Google Maps calculates a user's Estimated Time of Arrival (ETA)?”</p>\
  <p class='text-gray-300'><strong>Step 1: Listen & Clarify</strong></p>\
  <p class='text-gray-300'>Great question. To make sure I answer what you're looking for, can I ask a few things? Are we talking about ETA for driving, walking, or public transit? And are we focused on the real-time calculation for an active trip, or the initial estimate before a user starts driving?</p>\
  <p class='text-gray-300'><i>(Let's assume the interviewer says \"real-time ETA for driving.\")</i></p>\
  <p class='text-gray-300'><strong>Step 2: Define the Scope & Goals</strong></p>\
  <p class='text-gray-300'>\"Okay, so we're focused on calculating a real-time driving ETA. The primary goal is to provide the user with an accurate and constantly updated arrival time to build trust and help them plan. The system needs to be fast, reliable, and account for changing conditions.\"</p>\
  <p class='text-gray-300'><strong>Step 3: Structure the System (High-Level)</strong></p>\
  <p class='text-gray-300'>\"At a high level, the system needs three things:\"</p>\
  ...
  <p class='text-gray-300'><strong>Step 4: Explain the Components (Step-by-Step)</strong></p>\
  <p class='text-gray-300'>\"Let's walk through the journey:\"</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'><strong>Step 5: Identify Trade-offs & Risks</strong></p>\
  <p class='text-gray-300'>\"This system involves some critical trade-offs:\"</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Your Technical Toolkit: Key Concepts Explained Simply</h2>\
  <p class='text-gray-300'>To talk about system components, you just need a basic vocabulary. Here are the essentials.</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Concept: Client / Front-end</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>Concept: Server / Back-end</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>Concept: API (Application Programming Interface)</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>Concept: Database</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>Concept: Cache / CDN</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Sample Example: \"How does Google Docs work?\"</h2>\
  <p class='text-gray-300'>Let's use our 6-step framework from the previous module.</p>\
  <p class='text-gray-300'><strong>Step 1: Clarify</strong></p>\
  <p class='text-gray-300'>\"Good question. To focus my answer, are you most interested in the real-time collaboration feature where multiple users can type at once, or another aspect like offline mode?\"</p>\
  <p class='text-gray-300'><i>(Interviewer: \"Let's focus on the real-time collaboration.\")</i></p>\
  <p class='text-gray-300'><strong>Step 2: Define Scope & Goals</strong></p>\
  <p class='text-gray-300'>\"Okay, so we're designing the core real-time collaboration for Google Docs. The user goal is that users can see each other's changes instantly and the document always stays in sync. No work should ever be lost. The system goal is that the system must have very low latency (be fast), be highly available (never go down), and ensure data consistency (everyone sees the same version).\"</p>\
  <p class='text-gray-300'>User Goal: Users can see each other's changes instantly and the document always stays in sync. No work should ever be lost.</p>\
  <p class='text-gray-300'>System Goal: The system must have very low latency (be fast), be highly available (never go down), and ensure data consistency (everyone sees the same version).</p>\
  <p class='text-gray-300'><strong>Step 3: Structure the System (High-Level)</strong></p>\
  <p class='text-gray-300'>\"At a high level, we'll have:\"</p>\
  <ol class='list-decimal pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'><strong>Step 4: Explain the Components (Step-by-Step)</strong></p>\
  <p class='text-gray-300'>\"When a user opens a doc, the <strong>Client</strong> (their browser) loads the document from the <strong>Server.</strong>\"</p>\
  <p class='text-gray-300'>To handle real-time edits, the Client establishes a persistent connection to the Server. When User A types 'hello,' their Client doesn't wait to bundle changes. It immediately sends that tiny change (e.g., 'insert H at position 5') to the Server via an <strong>API.</strong></p>\
  <p class='text-gray-300'>The <strong>Server</strong> receives this change, validates it, and then broadcasts it out to all other connected clients (like User B's browser). User B's browser then inserts 'H' at position 5 on their screen. The server then saves this new document version to the <strong>Database</strong> for permanent storage.\"</p>\
  <p class='text-gray-300'><strong>Step 5: Identify Trade-offs & Risks</strong></p>\
  <p class='text-gray-300'>\"Here's where the interesting product decisions are:\"</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li><strong>Consistency vs. Speed:</strong> What if two users type in the same spot at the exact same time? The system needs a rule to resolve this conflict (this is called 'operational transforms'). We prioritize a consistent view for everyone over showing an edit that might later be undone, which would be a confusing user experience.</li>\
  <li><strong>Risk - Network Connection:</strong> What if a user goes offline for a second? The system needs to handle this gracefully. The client should probably save the changes locally and then sync them with the <strong>server</strong> once the connection is back. This is a crucial feature for ensuring no data is lost.</li>\
  <li><strong>Cost vs. Performance:</strong> Maintaining a constant connection to the server for every single user is expensive. We trade this cost for the magical real-time experience, which is Google Docs' key differentiator.</li>\
  </ul>\
  <p class='text-gray-300'><strong>Step 6: Summarize & Check-in</strong></p>\
  <p class='text-gray-300'>\"So, in summary, Google Docs creates its real-time experience using a persistent connection between the client and server, allowing tiny changes to be sent and broadcast instantly. The core product challenge is managing the trade-offs between consistency, performance, and cost to create a seamless and reliable user experience. Is there any part of that system you'd like to discuss further?\"</p>\
  </div>",
    },
    {
      ...
      completed: 0,
      summary:
        "This module provides concise playbooks for five common technical PM interview questions. The goal is to see our frameworks in action and learn to deliver structured, high-impact answers.",
      htmlContent:
        "<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>\
  <h2 class='text-xl font-bold text-gray-50'>The \"Explain a Concept\" Question</h2>\
  <p class='text-gray-300'>\"How does an API work?\"</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>The \"Explain a System\" Question</h2>\
  <p class='text-gray-300'>\"Why might Gmail search be slower than Google Search?\"</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>The \"System Design\" Question</h2>\
  <p class='text-gray-300'>\"How would you design a risk alerting system for a fintech app?\"</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'>\"Assuming the risk is fraud, the system needs to:</p>\
  <ol class='list-decimal pl-6 space-y-1 text-gray-300'>\
  ...
  <p class='text-gray-300'>The critical PM trade-off is <strong>false Positives vs. false Negatives.</strong> A false positive annoys a user; a false negative (missing fraud) destroys trust. We must optimize to prevent missed fraud, even if it creates some friction.\"</p>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>The \"Debugging / Data\" Question</h2>\
  <p class='text-gray-300'>\"DAU dropped 10%. How would you debug this?\"</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li><strong>Hint:</strong> Use a structured, methodical approach. Eliminate simple explanations first.</li>\
  <li><strong>Sample Answer Gist:</strong></li>\
  </ul>\
  <p class='text-gray-300'>\"I'd investigate in this order:</p>\
  <ol class='list-decimal pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>The \"Non-Technical Communication\" Question</h2>\
  <p class='text-gray-300'>\"How would you explain cloud computing to a non-technical exec?\"</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li><strong>Hint:</strong> Use a strong analogy that focuses on business values such cost, speed, and flexibility.</li>\
  <li><strong>Sample Answer Gist:</strong></li>\
  </ul>\
  <p class='text-gray-300'>\"Cloud computing is like using the electrical grid instead of building your own power plant. You don't have the massive upfront cost or maintenance burden. You just plug in and pay for what you use. For our business, this means we can:</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  <li>Move faster</li>\
  <li>Reduce costs</li>\
  <li>Scale instantly to meet customer demand.\"</li>\
    ...
    },
    {
      ...
      completed: 0,
      summary:
        "A great product is built on great collaboration. Technical skills get you in the room, but your ability to align engineering, business, and design is what makes you an effective PM. Interviewers want to know: are you a force multiplier for your team, or just another source of friction?",
      htmlContent:
        "<div class='p-6 rounded-xl shadow-md space-y-6 bg-[#08090A] text-gray-200'>\
  <h2 class='text-xl font-bold text-gray-50'>The PM's Role: The Bi-Directional Translator</h2>\
  <p class='text-gray-300'>In an interview, be sure to highlight your collaboration style. Remember you are the bridge between the market and the makers.</p>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Sample Responses for Collaboration Questions</h2>\
  <p class='text-gray-300'>Here's how to talk about working with engineering day-to-day.</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Respecting Methodologies (Agile, Kanban, etc.)</h3>\
  <p class='text-gray-300'><strong>Example:</strong> \"<i>I see my role as providing the 'what' and the 'why,' and I trust my engineering partners to own the 'how.' I focus on delivering clear priorities and user stories, and I let the team decide if a two-week sprint or a continuous flow model is the best way to deliver value.</i>\"</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Integrating Tech into Vision</h3>\
  <p class='text-gray-300'><strong>Example:</strong> \"<i>Engineers are the best source of innovation. I bring my tech lead into the discovery process from day one. I share customer feedback, data, and user pain directly with the entire team so they feel connected to the 'why' behind their work.</i>\"</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Translating to Engineering Stories</h3>\
  <p class='text-gray-300'><strong>Example:</strong> \"<i>I work with my tech lead to break down large initiatives into small, testable user stories. We always use the 'As a user, I want to..., so that...' format. This ensures every piece of work is directly tied to user value, not just a list of tasks.</i>\"</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Bridging to Business Teams</h3>\
  <p class='text-gray-300'><strong>Example:</strong> \"<i>I act as a shield and a megaphone for my team. I shield them from random stakeholder requests and megaphone their progress and wins to the rest of the company, always framed in terms of business impact.</i>\"</p>\
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Resolving Common Tension Example</h2>\
  <p class='text-gray-300'>Every PM lives these conflicts. Show you can navigate them gracefully.</p>\
  <h3 class='text-lg font-semibold text-gray-100'>Tension 1: Speed vs. Quality (\"We need this feature now!\")</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <h3 class='text-lg font-semibold text-gray-100'>Tension 2: Tech Debt vs. New Features (\"We don't have time to refactor.\")</h3>\
  <ul class='list-disc pl-6 space-y-1 text-gray-300'>\
  ...
  <hr class='my-6 border-gray-700'/>\
  <h2 class='text-xl font-bold text-gray-50'>Example: Aligning Misaligned Stakeholders</h2>\
  <p class='text-gray-300'>The Head of Sales sold a key client a custom feature, promising it for Q1. Your Tech Lead looks at the request and says it's a 6-month architectural rebuild. Both are furious. What do you do?</p>\
  <ol class='list-decimal pl-6 space-y-2 text-gray-300'>\
  ...
  <p class='text-gray-300'>This approach turns you from a mediator into a strategic problem-solver.</p>\
  </div>",
    },
  ],
};
